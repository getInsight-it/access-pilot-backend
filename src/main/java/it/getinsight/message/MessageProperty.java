...
public enum MessageProperty implements IMessageProperty {
    ...
    CLIENT_IMPORT_CLIENT_ID_REQUIRED("client.import.client.id.required"),
    CLIENT_IMPORT_IGNORED("client.import.ignored"),
    CLIENT_IMPORT_ALREADY_EXISTS_NOT_FORCED("client.import.already.exists.not.forced"),
    ...
    INVALID_COLOR_ERROR("invalid.color"),
    ...
    LEVEL_IMPORT_EMPTY("level.import.empty"),
    LEVEL_IMPORT_NAME_REQUIRED("level.import.name.required"),
    LEVEL_IMPORT_NAME_DUPLICATE("level.import.name.duplicate"),
    LEVEL_IMPORT_TYPE_REQUIRED("level.import.type.required"),
    LEVEL_IMPORT_BUILT_IN_NOT_ALLOWED("level.import.built.in.not.allowed"),
    LEVEL_IMPORT_SELF_PARENT("level.import.self.parent"),
    LEVEL_IMPORT_PARENT_NOT_FOUND("level.import.parent.not.found"),
    ...
    ITEM_IMPORT_EMPTY("item.import.empty"),
    ITEM_IMPORT_NAME_REQUIRED("item.import.name.required"),
    ITEM_IMPORT_NAME_DUPLICATE("item.import.name.duplicate"),
    ITEM_IMPORT_SELF_PARENT("item.import.self.parent"),
    ITEM_IMPORT_PARENT_EXTERNAL_REQUIRED("item.import.parent.external.required"),
    ITEM_IMPORT_PARENT_NOT_FOUND("item.import.parent.not.found"),
    ITEM_IMPORT_BUILT_IN_NOT_ALLOWED("item.import.built.in.not.allowed"),
