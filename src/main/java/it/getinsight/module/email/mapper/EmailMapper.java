...
public interface EmailMapper extends BaseMapper<EmailSent, EmailDTO>, BaseGenericObjectMapper<EmailDTO> {

    @Mapping(target = "userId", source = "user.id")
    EmailDTO toDto(EmailSent emailSent);

    @InheritInverseConfiguration(name = "toDto")
    void fromDto(EmailDTO dto, @MappingTarget EmailSent entity);
