package it.getinsight.module.configuracao.service;
...
import it.getinsight.module.configuracao.mapper.ConfigurationMapper;
import it.getinsight.module.configuracao.repository.ConfigurationRepository;
...
public class ConfigurationService {
    ...
    private static final String NAME_QUERY_OBTER_TODAS_CONFIGURACOES = "obter-todas-configuracoes";
    ...
    public List<ConfigurationDTO> getAllConfigurationsDynamicQuery() {
        ...
        return configurationRepository.findAllNative(NAME_QUERY_OBTER_TODAS_CONFIGURACOES, parameters, configurationMapper);
    }
