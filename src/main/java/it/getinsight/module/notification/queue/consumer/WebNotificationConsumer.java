...
import it.getinsight.module.notification.service.NotificationWebService;
...
@Slf4j
public class WebNotificationConsumer implements QueueMessageHandler<NotificationPayloadDTO> {
    ...
    public void onMessage(QueueMessageDTO<NotificationPayloadDTO> message, String routingKey) {
        ...
        log.info("Creating web notification: type={}, recipientId={}, requestId={}",
            payload.getNotificationType(), payload.getRecipientId(), payload.getRequestId());

        notificationWebService.createWebNotification(payload);
    }
}
