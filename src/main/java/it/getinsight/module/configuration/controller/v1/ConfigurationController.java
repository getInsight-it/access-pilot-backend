...
//TODO: rever uso deste controller
/**
 * @RestController
 ...
 *
 *     private final AttachmentConfigurationService configurationService;
 *
 *     @PostMapping
 ...
 *     })
 *     public ResponseEntity<Void> create(@Valid @RequestBody AttachmentConfigurationDTO configurationDTO) {
 ...
 *         @ApiResponse(responseCode = "200", description = "Configuration found.", content = @Content(schema = @Schema(implementation = AttachmentConfigurationDTO.class))),
 *         @ApiResponse(responseCode = "400", description = "Invalid request."),
 *         @ApiResponse(responseCode = "401", description = "Unauthorized."),
 *         @ApiResponse(responseCode = "403", description = "Forbidden."),
 *         @ApiResponse(responseCode = "404", description = "Configuration not found."),
 *         @ApiResponse(responseCode = "500", description = "Internal server error.")
 *     })
 *     public ResponseEntity<AttachmentConfigurationDTO> findById(@PathVariable Long id) {
 ...
 *         @ApiResponse(responseCode = "500", description = "Internal server error.")
 *     })
 *     public ResponseEntity<PageableResponseModel<AttachmentConfigurationDTO>> findConfigurations(
 *                                                                             @Min(value = 1, message = "O índice da página deve ser no mínimo 1")
 *                                                                             @RequestParam(defaultValue = "1") Integer pageIndex,
 *                                                                             @RequestParam(defaultValue = "10") Integer pageSize,
 *                                                                             @RequestParam(defaultValue = "id") String sortField,
 *                                                                             @RequestParam(defaultValue = "ASC") String sortType,
 *                                                                           @ParameterObject AttachmentConfigurationFilterDTO filter
 *     ) {
